...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const redirectToLogin = () => {
      const url = `/admin/login?from=${encodeURIComponent(pathname)}`;
      router.push(url);
    };
    
    checkAuth();
  }, [isLoginPage, router, pathname, supabase]);
  ...
  const navigation = [
    ...
    { name: t('navigation.bouquets'), href: '/admin/bouquets', icon: Package },
    { name: t('navigation.flowers'), href: '/admin/flowers', icon: Palette },
    { name: t('navigation.categories'), href: '/admin/categories', icon: Grid },
    { name: t('navigation.tags'), href: '/admin/tags', icon: Tag },
  ];
