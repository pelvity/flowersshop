...
export default function ClientFlowerEditPage({ id, locale }: { id: string; locale: string }) {
  ...
  const [flower, setFlower] = useState({
    ...
    inStock: true,
    quantity: 120,
    image: '/images/flowers/red-rose.jpg'
  });

  const [loading, setLoading] = useState(false);

  // Mock fetch flower by id
  useEffect(() => {
    // In a real app, fetch flower data from API
    // setLoading(true);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <div className="mt-1 flex items-center">
                <div className="mr-4 h-40 w-40 overflow-hidden rounded-md bg-gray-100">
                  {flower.image && (
                    <img
                      src={flower.image}
                      alt={flower.name}
